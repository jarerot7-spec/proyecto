    ...
    return (
        <div className="page-background-wrapper">
            <div className="estado-container-main">
                {/* 1. Sección original de Historial de Pedidos */}
                ...
                {/* 2. Nueva Sección: Horas Pico del Día */}
                ...
                {/* 3. Nueva Sección: Inventario Disponible */}
                <div className="estado-card-box">
                    <div className="card-title-section">
                                ...
                                <div key={index} className="inventario-row">
                                    <div className="producto-detalle-col">
                                        <div className="producto-imagen-wrapper">
                                            {item.imagen && <img src={item.imagen} alt={item.nombre} className="producto-img-thumb" />}
